...
setwd("D:/S/基于健康增益宏观效应模型的疾病经济成本评估/fall/人力资本")
####疾病数据处理------
###数据导入及合并
...
data <- data[, -c(1, 4, 5)]
setwd("D:/S/基于健康增益宏观效应模型的疾病经济成本评估/全球糖尿病/实物资本及总产出")
...
setwd("D:/S/基于健康增益宏观效应模型的疾病经济成本评估/fall/实物资本及总产出")
...
remove(burden, pop)
setwd("D:/S/基于健康增益宏观效应模型的疾病经济成本评估/fall/Imputation")
